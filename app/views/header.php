...
<head>
  ...
  <link href="<?= ROOT; ?>public/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <!-- <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet"> -->

  <!-- Custom styles for this template-->
  <link href="<?= ROOT; ?>public/assets/css/sb-admin-2.css" rel="stylesheet" type="text/css">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= ROOT;?>home">
        <div class="sidebar-brand-icon">
          <h2 style="font-family: 'Fredoka One', cursive;" >H<span style="color: red;">P</span></h2>
        </div>
        <div class="sidebar-brand-text mx-3">
          <img src="/FrameworkJD/public/assets/img/logo.png" width="120" height="25" alt="">
        </div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTaller" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class=" bg-white py-2 collapse-inner rounded text-white-50">
            <a href="#" class=" collapse-item">Ordenes de servicio</a>
            <a href="#" class=" collapse-item">Vehiculos | Cajas</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- Topbar -->
        <nav class="navbar navbar-expand navbar-dark bg-gray-900 text-white-50 topbar mb-4 static-top shadow border-bottom-danger">
              ...
              <!-- <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="dropdown-list-image mr-3">
                    <img class="rounded-circle" src="/FrameworkJD/public/assets/img/profile/user.png" alt="">
