<?php
   ...
   class Cliente extends Persona{
        ...
        try{
            $consulta = Conexion::Conectar()->query("SELECT * FROM clientes")->rowCount();
            return $consulta;
        ...
        public function Listar(){
            try{
                $consulta = Conexion::Conectar()->prepare("SELECT id, identificacion, nombre, apellido, telefono, estatus FROM clientes");
                $consulta->execute();
        ...
        public function Borrar($id){
            try{
                $consulta = Conexion::Conectar()->prepare("DELETE FROM clientes WHERE id='$id'");
                $consulta->execute();
